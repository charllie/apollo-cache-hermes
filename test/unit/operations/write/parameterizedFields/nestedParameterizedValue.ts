...
describe(`operations.write`, () => {
  ...
  describe(`nested parameterzied values`, () => {
    ...
    beforeAll(() => {
      ...
      parameterizedId = nodeIdForParameterizedValue(
        QueryRootId,
        ['foo', 'bar', 'baz'],
        { id: 1, withExtra: true }
      );
