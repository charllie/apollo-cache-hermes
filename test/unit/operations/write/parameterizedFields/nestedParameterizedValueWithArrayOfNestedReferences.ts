...
describe(`operations.write`, () => {
  ...
  describe(`nested parameterized value with array of nested references`, () => {
    ...
    beforeAll(() => {
      ...
      entityId1 = '31';
      entityId2 = '32';
      parameterizedIdInEntity1 = nodeIdForParameterizedValue(
        entityId1,
        ['four'],
        { extra: true }
      );
      parameterizedIdInEntity2 = nodeIdForParameterizedValue(
        entityId2,
        ['four'],
        { extra: true }
      );
    ...
    it(`writes entity snapshots for each parameterized field of array entry`, () => {
      jestExpect(snapshot.getNodeSnapshot(parameterizedIdInEntity1))
        .toBeDefined;
      jestExpect(snapshot.getNodeSnapshot(parameterizedIdInEntity2))
        .toBeDefined;
    });
    ...
    it(`references the parameterized field children from the parent entity`, () => {
      ...
      jestExpect(entity2.outbound).toEqual(
        jestExpect.arrayContaining([
